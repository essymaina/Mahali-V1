...
export default function WorkspaceLoginPage() {
  ...
  const handleSubmit = async (e: { preventDefault: () => void }) => {
    ...
    try {
      ...
      localStorage.setItem("mahali-user-auth", JSON.stringify({ email, type: "workspace" }))
      ...
      <main className="flex-1 container mx-auto px-4 py-8 flex items-center justify-center">
        <div className="w-full max-w-md">
          <div className="bg-white p-8 border rounded-lg shadow-sm">
            ...
            <h1 className="text-2xl font-bold text-center mb-6">Workspace Owner Login</h1>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="space-y-2">
                <div className="flex items-center justify-between">
                  ...
                  <Link href="/auth/workspace/reset-password" className="text-sm text-[#0a1f56] hover:underline">
                    Forgot password?
                  </Link>
                </div>
                <Input
            ...
            <div className="mt-6 text-center">
              <p className="text-sm text-gray-500">
                ...
                <Link href="/auth/workspace/signup" className="text-[#0a1f56] hover:underline">
                  Sign up
                </Link>
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <Button variant="outline" className="w-full" onClick={() => router.push("/auth/user/login")}>
                Sign in as a user
              </Button>
            </div>
          </div>
